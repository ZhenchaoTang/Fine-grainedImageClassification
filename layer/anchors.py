...
if __name__ == '__main__':
    INPUT_SIZE = (448, 448)
    center_anchors, edge_anchors, anchor_areas=generate_default_anchor_maps(input_shape=INPUT_SIZE)
    print(center_anchors.shape, edge_anchors.shape, anchor_areas.shape) # (1614, 4) (1614, 4) (1614,)
    print(center_anchors[0], edge_anchors[0], anchor_areas[0])
    a = hard_nms(np.array([
        [0.4, 1, 10, 12, 20],
        [0.5, 1, 11, 11, 20],
        [0.55, 20, 30, 40, 50]
